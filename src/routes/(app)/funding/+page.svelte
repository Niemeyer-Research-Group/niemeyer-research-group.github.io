...
>
	<Image slot="image" url={"/images/funding/osu-logo.png"} alt="The Oregon State University logo"/>
	&mdash; My lab's primary source of funding is the School of Mechanical, Industrial, and Manufacturing Engineering (MIME) at Oregon State University. 
	It pays nine months of my salary, it sometimes subsidizes my graduate students' time through teaching assistantships, it provides space and staff support, and it provides my core intellectual community. 
	The School of MIME's resources come from tuition, fees, and taxes from the Oregon state government, and <External to="https://engineering.oregonstate.edu/give">philanthropic giving</External>.
</Block>
...
>
	<Image slot="image" url={"/images/funding/nsf.svg"} alt="The NSF logo." />
...
>
	<Image slot="image" url={"/images/funding/doe.svg"} alt="The DOE logo."/>
	&mdash; Through national labs like <External to="https://www.lbl.gov">Lawrence Berkeley National Laboratory</External> and <External to="https://www.sandia.gov">Sandia National Laboratories</External>,
...
<Block 
	...
	header="SERDP"
>
	<Image slot="image" url={"/images/funding/serdp.svg"} alt="The SERDP logo."/>
...
>
	<Image slot="image" url={"/images/funding/sloan.png"} alt="The Sloan Foundation logo."/>
...
<Block 
	...
	header="NASA"
>
	<Image slot="image" url={"/images/funding/nasa.svg"} alt="The NASA logo."/>
	&mdash; NASA has also supported my group's research into computational methods relevant to aerospace applications:
	<ul>
		{#each $profile.getFunding(
...
<Block 
	...
	header="Chevron"
>
	<Image slot="image" url={"/images/funding/chevron.svg"} alt="The Chevron logo."/>
	&mdash; Some of my early work at Oregon State was supported by Chevron, in collaboration with Chris Hagen. Despite the industry connection, this work was fairly fundamental, and mostly looked at suitability of fuels for advanced, highly efficient, low-temperature compression-ignition engines:
	<ul>
		{#each $profile.getFunding(
