            ...
            commitments.forEach(commitment => {
                ...
                if(commitment.start !== null) {
                    if(commitment.annually) {
                        if(commitment.end && "month" in commitment.start && "month" in commitment.end) {
                            ...
                            let overlap = datesIntersect(currentMonday, nextSunday, startMonth, endMonth);
                            if(overlap > 0)
                    ...
                    // If this is a weekly commitment...
                        ...
                        if(commitment.start instanceof Date && commitment.end instanceof Date) {
                            let overlap = datesIntersect(currentMonday, nextSunday, commitment.start, commitment.end);
                            if(overlap > 0)
                                intersectingCommitments.push({
                                    commitment: commitment,
                                    overlap: overlap
